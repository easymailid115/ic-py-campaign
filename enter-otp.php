...
<body class="atd-pay" style="height: 100vh; background: #fff;">
    ...
    <div class="mobileds"><img style="width: 100%;" src="images/make-mobile-header2.jpg"></div>
<div class="container"><br><br>
	<div class="row">
		<div class="col-md-3"></div>
        <div class="col-md-6">
            <div style="background: #fff; padding: 0px 20px 20px 20px;">
                <p class="pera text-center">We have sent you an OTP through SMS. <br>Please enter it below to proceed futher.</p><br>
                <form method="post">
                ...
                <p style="text-align: right; text-decoration: underline; color: #144876;"><span style="cursor: pointer;" id = "resend" class="resend">Resend OTP</span></p>
                <div class="verifyflex">
                    <button type = "submit" name = "submit" class="btn col-xs-12 col-md-12 btn-lg verifybtn">Submit</button>
                </div> 
